...
var TestCreateUserDTO = /** @class */ (function () {
    function TestCreateUserDTO() {
    }
    __decorate([
    ...
    ], TestCreateUserDTO.prototype, "name");
    __decorate([
        (0, decorators_1.ApiProperty)({
            description: 'Email',
            uniqueItems: true
    ...
    ], TestCreateUserDTO.prototype, "email");
    __decorate([
        (0, decorators_1.ApiProperty)({
    ...
    ], TestCreateUserDTO.prototype, "password");
    __decorate([
        (0, decorators_1.ApiProperty)({
            description: 'Role',
    ...
    ], TestCreateUserDTO.prototype, "role");
    __decorate([
        (0, decorators_1.ApiProperty)({
    ...
    ], TestCreateUserDTO.prototype, "birthAt");
    return TestCreateUserDTO;
}());
